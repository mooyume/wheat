...
parser.add_argument('--model_name', type=str, default='kan_two_branch',
                    help='save model name [kan_two_branch, 3d]')
...
parser.add_argument('--n_head', type=int, default=2, help='transformer config number of head')
...
parser.add_argument('--loss_f', type=str, default='rmse', help='loss function [mse, l1, rmse]')
