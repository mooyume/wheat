...
if __name__ == '__main__':
    ...
    build_data(r'E:\25holiday\Dataset\Finally\lzw_mod09a1\guanzhong', './data', r'./data/code/guanzhong_code.txt')
    ...
    # build_data(r'/root/old_data/lzw_mod09a1/Henan', './data', r'./data/code/henan_code.txt')
